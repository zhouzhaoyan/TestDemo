...
//        new PlugSignin().runClick(null, ClickTool.ClientType.火树搜狗, new Coordinate(399, 298));
    }
    ...
    private CheckBox getCheckBox(ClickTool.ClientType clientType) {
        ...
        switch (clientType) {
            ...
            case 火树360浏览器:
                ...
                break;
            case 趣头条360浏览器:
                checkBox = (CheckBox) findViewById(R.id.game39);
                break;
            case 玩蛋360浏览器:
                checkBox = (CheckBox) findViewById(R.id.game40);
                break;
            case 游戏1758浏览器360:
                checkBox = (CheckBox) findViewById(R.id.game41);
                break;
            case 乐趣360浏览器:
                checkBox = (CheckBox) findViewById(R.id.game42);
                break;
            case 游戏07073浏览器360:
                checkBox = (CheckBox) findViewById(R.id.game43);
                break;
            case 牛刀浏览器360:
                checkBox = (CheckBox) findViewById(R.id.game44);
                break;
            case 游戏1758猎豹浏览器:
            ...
            case 玩蛋360极速:
                ...
                break;
            case 火树uc极速:
                checkBox = (CheckBox) findViewById(R.id.game54);
                break;
            case 趣头条uc极速:
                checkBox = (CheckBox) findViewById(R.id.game55);
                break;
            case 玩蛋uc极速:
                checkBox = (CheckBox) findViewById(R.id.game56);
                break;
            case 火树搜狗:
                checkBox = (CheckBox) findViewById(R.id.game57);
                break;
            case 趣头条搜狗:
                checkBox = (CheckBox) findViewById(R.id.game58);
                break;
            case 玩蛋搜狗:
                checkBox = (CheckBox) findViewById(R.id.game59);
                break;
            case 火树搜狗极速:
                checkBox = (CheckBox) findViewById(R.id.game60);
                break;
            case 趣头条搜狗极速:
                checkBox = (CheckBox) findViewById(R.id.game61);
                break;
            case 玩蛋搜狗极速:
            ...
            case 玩蛋uc极速双开:
                ...
                break;
            case 火树360极速双开:
                checkBox = (CheckBox) findViewById(R.id.game66);
                break;
            case 趣头条360极速双开:
                checkBox = (CheckBox) findViewById(R.id.game67);
                break;
            case 玩蛋360极速双开:
